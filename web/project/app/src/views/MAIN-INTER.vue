<template>
  ...
  <el-container>
    ...
    <el-main class="mainMain" v-loading = 'loding' >
         <!--面包屑导航区域-->
   ...
   <el-tag style="width: 110px; height: 50px">目的机场</el-tag>
      ...
      <div class = "gl">
        ...
        <el-main class="getmain" v-loading = 'loding'>
            <el-table
                    :data="tableData"
                    style="width: 100%"
                    max-height="250">
        ...
        data() {
            return {
                imgList:[
                    ...
                    {
                        url:require('@/assets/img/pic8.png')
                    }
                ],
                mainForm: {
                     showmsg : '',
                ...
                arriveList: [],
                totalList :[],
                tableData : [{date:'',name:'',province:'',city:'',address:''}],
                loding : false
        ...
        methods: {
            openMsgHint(msg,data1) {
                this.$confirm('是否选择'+msg+'为出发机场', '提示', {
                    ...
                    this.loding=true;
                    this.tableData[0].date =this.getCode(data1,msg);
                    this.tableData[0].name = msg;
                    this.msg = msg;
            ...
            openEMsgHint(msg,data1) {
                if(msg!=this.msg) {
                    this.$confirm('是否选择' + msg + '为目的机场', '提示', {
                        ...
                        this.loding=true;
                        this.tableData[0].province = this.getCode(data1, msg);
                        this.tableData[0].city = msg;
                        this.emsg = msg;
            ...
            timeSelected(){
                ...
                if(this.msg!= "请选择" && this.emsg!="请选择"){
                    ...
                    this.tableData[0].address=this.mainForm.value1;
                }
            },
            toCancel() {
                alert("取消");
